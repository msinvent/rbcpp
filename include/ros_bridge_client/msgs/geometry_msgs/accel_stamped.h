...
struct AccelStamped : public MessageBase
{
  ...
  AccelStamped(const Accel &accel, std::string frame_id);
...
std::ostream &operator<<(std::ostream &os, const std::shared_ptr<ros_bridge_client::msgs::geometry_msgs::AccelStamped> &a);
